...
export function TestTypes(): React.JSX.Element {
  return (
    <section
      id="tipos"
      className="border-border bg-surface-2/40 flex min-h-[calc(100svh-4rem)] flex-col justify-center border-t"
    >
      <div className="mx-auto w-full max-w-6xl px-5 py-20 sm:px-8 lg:py-24">
                ...
                return (
                  <div key={type.name} className="bg-surface p-5">
                    <div className="flex items-center gap-2.5">
                      <span className="bg-surface-2 text-accent-text grid size-8 place-items-center rounded-md">
                        <Icon size={16} />
                      </span>
        ...
        <Reveal delay={160}>
          <Callout className="mt-6">
            El tipo <strong className="text-text font-medium">Login</strong> no
            ejecuta los selectores al pie de la letra: una heurística localiza
            el campo de identificador, la contraseña y el botón, y verifica el
            resultado por comportamiento. Tolera cualquier idioma y maquetado —
            un selector exótico no rompe la prueba.
          </Callout>
        </Reveal>
      </div>
    </section>
